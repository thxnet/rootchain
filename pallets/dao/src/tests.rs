...
fn test_successful_voting_with_minimum_requirements() {
	...
	ext.execute_with(|| {
		...
		assert_ok!(Dao::raise_topic(
			...
			"This topic tests the minimum requirements for a successful raise."
				.as_bytes()
				.to_vec(),
			voting_period_start_in_second,
			voting_period_end_in_second,
...
fn test_vote_with_insufficient_weight() {
	...
	ext.execute_with(|| {
		...
		assert_ok!(Dao::raise_topic(
			...
			"This topic should fail due to insufficient weight for voting."
				.as_bytes()
				.to_vec(),
			voting_period_start_in_second,
			voting_period_end_in_second,
...
fn test_duplicate_vrt_issuance() {
	...
	ext.execute_with(|| {
		...
		assert_ok!(Dao::raise_topic(
			...
			"This topic should fail due to duplicate VRT issuance attempt."
				.as_bytes()
				.to_vec(),
			voting_period_start_in_second,
			voting_period_end_in_second,
...
fn test_successful_vrt_issuance_with_default_weight_ratio() {
	...
	ext.execute_with(|| {
		...
		assert_ok!(Dao::raise_topic(
			...
			"This topic tests the default weight ratio for VRT issuance."
				.as_bytes()
				.to_vec(),
			voting_period_start_in_second,
			voting_period_end_in_second,
...
fn test_vrt_issuance_for_expired_topic() {
	...
	ext.execute_with(|| {
		...
		assert_ok!(Dao::raise_topic(
			...
			"This topic should fail due to VRT issuance for an expired topic."
				.as_bytes()
				.to_vec(),
			voting_period_start_in_second,
			voting_period_end_in_second,
...
fn test_vrt_issuance_with_maximum_voters() {
	...
	ext.execute_with(|| {
		...
		assert_ok!(Dao::raise_topic(
			...
			"This topic tests VRT issuance with the maximum number of voters."
				.as_bytes()
				.to_vec(),
			voting_period_start_in_second,
			voting_period_end_in_second,
